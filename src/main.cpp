...
// WiFi credentials
const char* ssid = "Cubyte-Mesh";  // Replace with your WiFi SSID
const char* password = "Jukebox01";  // Replace with your WiFi password

// MQTT Broker details
const char* mqtt_server = "81.2.140.229";
...
void handleRoot() {
  ...
  html += "<meta http-equiv='refresh' content='2'>"; // Refresh page every 5 seconds
  ...
  html += "<script>setTimeout(function() { window.location.reload(); }, 5000);</script>"; // Refresh page every 5 seconds
  html += "</head><body>";
  ...
  // Add Reset Button at the bottom of the table
